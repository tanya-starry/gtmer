...
const documents = [
  {
    ...
    tags: ["SOP"],
    title: "产品发布流程SOP",
    desc: "适用于新产品上市的标准操作流程，涵盖定价、渠道、推广全流程执行指南",
    date: "2026-04-15",
    uses: 24,
  },
  {
  ...
  },
  {
    id: 5,
    tags: ["SOP"],
    title: "客户 Onboarding 流程",
    desc: "新客户引导标准流程，从签约到首次成功使用",
    date: "2026-04-05",
    uses: 45,
  },
  {
...
export function KnowledgePage() {
  ...
  const filteredDocs = documents.filter((doc) => {
    const matchCategory =
      activeCategory === "全部" || doc.tags.includes(activeCategory);
    const matchSearch =
      searchQuery === "" ||
      ...
      <div className="max-w-[1280px] mx-auto px-6 lg:px-8 py-8 lg:py-12">
        ...
        >
          ...
          <input
            ...
            className="w-full h-12 pl-11 pr-4 bg-[#FAFAFA] border border-[#E2E8F0] rounded-xl text-sm text-[#0F172A] placeholder:text-[#94A3B8] focus:outline-none focus:border-[#3B82F6] focus:ring-2 focus:ring-[#3B82F6]/15 transition-all duration-200"
          />
        </motion.div>
