...
export function AgentWorkshopPage() {
        ...
        <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4 mb-8">
          <div>
            <motion.h1
              ...
              className="text-4xl lg:text-5xl font-bold text-[#1E40AF]"
            >
              Agent工坊
            </motion.h1>
            <motion.p
          ...
          {agents.map((agent, index) => (
            ...
            >
              ...
              <div
                ...
                style={{
                  backgroundColor: agent.status === "运行中" ? agent.color : "#E2E8F0",
                }}
              />
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-1.5 mt-0.5">
                    <div
                      ...
                      style={{
                        backgroundColor:
                          agent.status === "运行中" ? "#10B981" : "#94A3B8",
                      }}
                    />
            ...
            >
              ...
              <div className="p-6 space-y-6">
                ...
                <div>
                  ...
                  <p className="mt-1.5 text-sm text-[#0F172A]">
              ...
              <div className="p-6 space-y-6">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {["GPT-4o", "Claude-3.5", "GPT-4", "Claude-3"].map(
                      (model) => (
                        <button
                          key={model}
                  ...
                  <div className="space-y-2">
                    {skillList.map((skill) => (
                      ...
                      >
                        <input
                          type="checkbox"
                          className="w-4 h-4 rounded border-[#CBD5E1] text-[#1E40AF] focus:ring-[#3B82F6]"
                        />
                        <div>
                          <p className="text-sm font-medium text-[#0F172A]">
                            {skill.label}
